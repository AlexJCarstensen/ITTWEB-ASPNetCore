...
namespace ITTWEB_ASPNetCore.Data.Migrations
{
    ...
    [Migration("20161201172839_Initial")]
    partial class Initial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ITTWEB_ASPNetCore.Models.AccountViewModels.Category", b =>
                {
            ...
            modelBuilder.Entity("ITTWEB_ASPNetCore.Models.AccountViewModels.Component", b =>
                {
            ...
            modelBuilder.Entity("ITTWEB_ASPNetCore.Models.AccountViewModels.ComponentType", b =>
                {
                    b.Property<long>("ComponentTypeId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ITTWEB_ASPNetCore.Models.AccountViewModels.ESImage", b =>
                {
            ...
            modelBuilder.Entity("ITTWEB_ASPNetCore.Models.AccountViewModels.Component", b =>
                {
                    b.HasOne("ITTWEB_ASPNetCore.Models.AccountViewModels.ComponentType")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("ITTWEB_ASPNetCore.Models.AccountViewModels.ComponentType", b =>
                {
                    b.HasOne("ITTWEB_ASPNetCore.Models.AccountViewModels.ESImage", "Image")
                        .WithMany()
            ...
            modelBuilder.Entity("ITTWEB_ASPNetCore.Models.CategoryComponentType", b =>
                {
                    b.HasOne("ITTWEB_ASPNetCore.Models.AccountViewModels.Category", "Category")
                        .WithMany("CategoryComponentTypes")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ITTWEB_ASPNetCore.Models.AccountViewModels.ComponentType", "ComponentType")
                        .WithMany("CategoryComponentTypes")
                        .HasForeignKey("ComponentTypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
